# Births per year - Data package

This data package contains the data that powers the chart ["Births per year"](https://ourworldindata.org/grapher/number-of-births-per-year?country=~USA&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
